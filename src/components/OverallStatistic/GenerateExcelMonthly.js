...
const GenerateExcelMonthly = props => {
    ...
    if (expenses && currentUser && selectedMonth && selectedYear) {
        ...
        let stringMonth = Number(selectedMonth) + 1
        let pageTitle = `Expenses in ${stringMonth}'rd month of ${selectedYear}`;
...
export default GenerateExcelMonthly;
